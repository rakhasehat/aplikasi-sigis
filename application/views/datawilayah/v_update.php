          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="tab-content add-form" id="nav-tabContent">
				...
				<form action="<?= base_url('wilayah/proses_update') ?>" method="POST">
					<input type="hidden" value="<?= $w->id_trotoar ?>" name="id_trotoar">

					<div class="form-group">
					  <label class="control-label col-xs-3">Kode Trotoar</label>
						<div class="col-xs-8">
						  <input name="kode_trotoar" value="<?= $w->kode_trotoar ?>" class="form-control" type="text" required>
					  </div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-8">
							<input name="nama" class="form-control" value="<?= $w->nama_trotoar ?>" type="text" required>
						</div>
					</div>
			...
			<?php } ?>
                ...
                <div class="tab-pane fade" id="info-penanganan" role="tabpanel" aria-labelledby="nav-contact-tab">
                  <div class="card">
                    <div class="card-header py-3 add-table-header" style="justify-content: flex-start !important">
                      <h6 class="m-0 font-weight-bold text-primary add-table-header--1">Form Manajemen Data Distrik /
                        Kecamatan</h6>
